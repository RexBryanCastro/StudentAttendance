    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-xl px-4 mt-n10">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <select name="selectSection" id="selectSection" class="form-control" style="width:25%">
                                <option value="0" disabled selected>Select Section</option>
                            </select><br>

                            <label for="getDate">Date:</label>
                            <input type="date" name="date" id="getDate" class="form-control" style="width:25%">
                            <script>
                            const selectSection = document.getElementById("selectSection");
                            const onLoad = () => {
                                const formData = new FormData();
                                formData.append("job", "getSection");
                                formData.append(
                                    "json",
                                    JSON.stringify({
                                ...
                                axios({
                                    ...
                                    documents.forEach((docus) => {
                                        var option = document.createElement("option");
                                        option.setAttribute("value", docus.section_id);
                                        option.textContent = docus.section_name;
                                        selectSection.appendChild(option);
                                        // console.log(docus.doc_id);
                                    });
                                });
                            };
                            var getDate = document.getElementById("getDate");
                            getDate.addEventListener("change", () => {
                                const datevalue = document.getElementById("getDate").value;
                                const selectSection = document.getElementById("selectSection").value;
                                console.log(datevalue);
                                const formData = new FormData();
                                formData.append("job", "getStudentAttendance");
                                formData.append(
                                    "json",
                                    JSON.stringify({
                                        datevalue: datevalue,
                ...
                <td>${studentData.attendance_date}</td>
                <td>${studentData.section_name}</td>
                <td>${statusMap[studentData.attendance_status]}</td>
            `;
