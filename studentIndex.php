...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="studentIndex.php">Student <?php echo $user_name ?> </a>
        <!-- Navbar Search Input-->
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody> <?php
                                        ...
                                        $users = $conn->query("SELECT * FROM `tblattendance` a INNER JOIN tblusers b ON  a.attendance_student = b.user_id WHERE a.attendance_student = '$user_id'");
                                        $i = 1;
