...
<body class="nav-fixed">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
        ...
        <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="adminaddsched.php">Program Head </a>
        <!-- Navbar Search Input-->
                    ...
                    <div class="card mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <input data-user-id="<?php echo $row['class_id']; ?>" type="button" class="btn btn-info update-user-btn" value="Update"> <input data-user-id="<?php echo $row['class_id']; ?>" type="button" class="btn btn-danger delete-user-btn" value="Delete"></td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
                                    <tfoot>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" id="scheID" placeholder="Enter first name">
                                        </div>
                                        <div class="form-group">
                                            <label for="firstName">Class Code</label>
                                            <input type="text" class="form-control" id="iclasscode" placeholder="Enter first name">
                                        </div>
                                        <div class="form-group">
                                            <label for="lastName">Class Name</label>
                                            <input type="text" class="form-control" id="iclassname" placeholder="Enter last name">
                                        </div>
                                    </div>
                        ...
                        <script>
                            ...
                            addInstructor.addEventListener("click", () => {
                                ...
                                formData.append("job", "addSchedule");
                                formData.append(
                                    "json",
                                    JSON.stringify({
                                ...
                                axios({
                                    ...
                                    if (response.data != "0") {
                                        alert("added success");
                                        window.location.href = 'adminaddsched.php';
                                    } else {
                                        alert("added failed");
                                    }
                                });
                            ...
                            $(document).ready(function() {
                                $("table#datatablesSimple").on("click", ".delete-user-btn", function() {
                                    ...
                                    if (confirmDelete) {
                                        const formData = new FormData();
                                        formData.append("job", "deleteSchedule");
                                        formData.append(
                                            "json",
                                            JSON.stringify({
                                                schedID: userId,
                            ...
                            $(document).ready(function() {
                                ...
                                $("table#datatablesSimple").on("click", ".update-user-btn", function() {
                                    var userId = $(this).data("user-id");
                                    const formData = new FormData();
                                    formData.append("job", "viewSchedule");
                                    formData.append(
                                        "json",
                                        JSON.stringify({
                                            schedIDs: userId,
                                    ...
                                    axios({
                                        ...
                                        if (response.data != "0") {
                                            ...
                                            information.forEach((user) => {
                                                document.getElementById("iclasscode").value = user.class_code;
                                                document.getElementById("iclassname").value = user.class_name;
                                                document.getElementById("scheID").value = user.class_id;
                                ...
                                $("#updateUserInfoBtn").click(function() {
                                    ...
                                    var iclassname = $("#iclassname").val();
                                    var scheID = $("#scheID").val();

                                    const formData = new FormData();
                                    formData.append("job", "updateSchedule");
                                    formData.append(
                                        "json",
                                        JSON.stringify({
                                            scheID: scheID,
