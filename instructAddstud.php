                ...
                <div class="container-xl px-4 mt-n10">
                    <div class="card mb-4">
                            ...
                            <form>
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="schoolID" placeholder="First Name">
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><canvas id="qrCodes<?php echo $row['user_id']; ?>"></canvas></td>
                                            ...
                                            <script>
                                                function onLoad<?php echo $row['user_id']; ?>() {
                                                    var qr = new QRious({
                                                        element: document.getElementById("qrCodes<?php echo $row['user_id']; ?>"),
                                                        // Use the user ID as a value
                                                        value: "<?php echo $row['user_id']; ?>",
                                                        size: 100
                                                    });
                                                }

                                                onLoad<?php echo $row['user_id']; ?>();
                                            </script>
                                        <?php endwhile; ?>
                                    </tbody>
                        ...
                        <div class="modal fade" id="updateUserModal" tabindex="-1" role="dialog" aria-labelledby="updateUserModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document"> <!-- Changed modal-dialog class to modal-lg -->
                                                ...
                                                <div class="col-xl-4">
                                                    ...
                                                    <div class="card mb-4 mb-xl-0">
                                                        ...
                                                        <div class="card-body text-center">
                                                            <input type="text" class="form-control" id="userIDqrCode">
                                                            <canvas id="qrCode"></canvas>
                                                            <button class="btn btn-success mt-3 hidden" id="downloadBtn" onclick="downloadQRCode()">Download</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-8"> <!-- Adjusted column width -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="iextension" placeholder="Enter first name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name">Sex*</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="middleName">Birthdate</label>
                                                        <input type="date" class="form-control" id="ibirthdate" placeholder="Enter middle name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="middleName">Address</label>
                                                        <input type="text" class="form-control" id="iaddress" placeholder="Enter middle name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <script>
                            ...
                            // var userID = document.getElementById("userIDqrCode").value;
                            // console.log(userID);
                            // var qr = new QRious({
                        ...
                        <script>
                            ...
                            addInstructor.addEventListener("click", () => {
                                ...
                                formData.append("job", "addStudent");
                                formData.append(
                                    "json",
                                    JSON.stringify({
                                ...
                                axios({
                                    ...
                                    if (response.data != "0") {
                                        alert("added success");
                                        window.location.href = 'instructAddstud.php';
                                    } else {
                                        alert("added failed");
                                    }
                                });
                            ...
                            $(document).ready(function() {
                                $("table#datatablesSimple").on("click", ".delete-user-btn", function() {
                                    ...
                                    if (confirmDelete) {
                                        const formData = new FormData();
                                        formData.append("job", "deleteStudent");
                                        formData.append(
                                            "json",
                                            JSON.stringify({
                                                studentID: userId,
                            ...
                            $(document).ready(function() {
                                ...
                                $("table#datatablesSimple").on("click", ".update-user-btn", function() {
                                    var userId = $(this).data("user-id");
                                    document.getElementById("userIDqrCode").value = userId;
                                    console.log(document.getElementById("userIDqrCode").value);
                                    var userID = document.getElementById("userIDqrCode").value;
                                    console.log(userID);
                                    var qr = new QRious({
                                        element: document.getElementById("qrCode"),
                                    ...
                                    const formData = new FormData();
                                    formData.append("job", "viewStudent");
                                    formData.append(
                                        "json",
                                        JSON.stringify({
                                            studentIDs: userId,
                                    ...
                                    axios({
                                        ...
                                        if (response.data != "0") {
                                            ...
                                            information.forEach((user) => {
                                                ...
                                                document.getElementById("iextension").value = user.extension;
                                                document.getElementById("igender").value = user.gender;
                                                document.getElementById("ibirthdate").value = user.birthdate;
                                ...
                                $("#updateUserInfoBtn").click(function() {
                                    ...
                                    var studID = $("#instrID").val();
                                    var iextension = $("#iextension").val();
                                    var igender = $("#igender").val();
                                    var ibirthdate = $("#ibirthdate").val();
                                    var iaddress = $("#iaddress").val();

                                    const formData = new FormData();
                                    formData.append("job", "updateStudent");
                                    formData.append(
                                        "json",
                                        JSON.stringify({
                                            studID: studID,
